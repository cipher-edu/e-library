...
class IssueBook(models.Model):
    ...
    issued_date = models.DateField(verbose_name='Berilgan kuni', auto_now_add=True, editable=False)
    returned_date = models.DateField(verbose_name='Qaytish sansi', blank=True, null=True)
